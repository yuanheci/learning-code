...
void Select(HuffmanTree &H, const int n, int &i1, int &i2)
{
    ...
    //找出最小的一个
    auto flag1 = vec.begin();                                //flag1为指向最小值的迭代器
    ...
    i1 = *flag1; //最小的元素下标
    vec.erase(flag1);                                        //删除当前vector容器中的最小值
...
![image](https://user-images.githubusercontent.com/97277559/149771321-66336d82-eb77-409c-a807-6a96594151c4.png)

王卓老师上课代码：
![image](https://user-images.githubusercontent.com/97277559/149770893-07ee2ae9-6a7a-4986-819d-3926f86b1c11.png)
